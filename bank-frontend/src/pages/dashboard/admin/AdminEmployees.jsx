...
const AdminEmployees = () => {
  ...
  const fetchEmployees = async () => {
    ...
    try {
      ...
      const empData = Array.isArray(resp.data) ? resp.data : (resp.data?.content || []);
  ...
  const fetchBranches = async () => {
    try {
      ...
      const branchData = Array.isArray(resp.data) ? resp.data : (resp.data?.content || []);
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Mapped User ID</th>
